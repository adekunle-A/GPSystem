...
<script type="text/javascript" src="javascripts/docViewAppointmentScripts.js"></script>
</head>
<body>
<% 
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="ViewAppointment.jsp">View Appointments</a></li>
      ...
      <div class="col-md-9 col-md-offset-2">
        <div class="panel panel-login">
          <div class="panel-heading">
            <div class="row">
              <div class="col-xs-7">
                <a href="ViewAppointment.jsp" class="active" id="login-form-link">Doctor's Upcoming Appointments</a>
              </div>
            </div>
            <hr>
          ...
          <div class="panel-body">
              <div class="col-lg-12">
					  <div id="upappointments"></div>
					  <div class="hidden">
					   <table class="table gen" id="infoTable">
                       <tbody class="docappointments">
                      </tbody>
                  	</table>
                  	</div>
              </div>
